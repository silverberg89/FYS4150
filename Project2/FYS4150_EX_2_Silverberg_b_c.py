...
''' The convergence rate of the Jacobi method is however poor, one needs
    typically 3n2−5n2 rotations and each rotation requires 4n operations,
    resulting in a total of 12n3−20n3 operations in order to zero out
    non-diagonal matrix elements FROM NOTES'''
